...
urlpatterns = [
    ...
    path('aulas_por_turma/<int:turma>/', mynota.views.aulas_por_turma, name='aulas_por_turma'),
    path('modulos_por_turma/<int:turma>/', mynota.views.modulos_por_turma, name='modulos_por_turma'),
    path('notas_da_turma/<int:turma>/', mynota.views.notas_da_turma, name='notas_da_turma'),
    path('plano_aula/add/', mynota.views.plano_aula_add, name='plano_aula_add'),
    path('planos_por_turma/<int:turma>/', mynota.views.planos_por_turma, name='planos_por_turma'),
